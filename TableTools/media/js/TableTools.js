...
var TableToolsInit = {
	...
	"sPrintMessage": "",
	"sTitle": "",
	"sSwfPath": "TableTools/media/swf/ZeroClipboard.swf",
	"iButtonHeight": 30,
	"iButtonWidth": 30,
...
function TableTools ( oInit )
{
	...
	function fnFeaturePrint ()
	{
		...
		$(nButton).click( function() {
			...
			nInfo.innerHTML = "<h6>Print view</h6><h7>Please use your browser's print function <br/>or Press (CTRL + R) to "+
				"print this table. <br/>Refresh page (Press F5) to exit.</h7>";
